...
def rochambeau(a, desiredOutcome):
    if a == 1 and desiredOutcome == 1:  #Rock and I need to Lose
        return 3  #Rock beats scissors
    elif a == 1 and desiredOutcome == 3:  #Rock and I need to Win
        return 2 #Paper covers Rock
    elif a == 2 and desiredOutcome == 1:  #Paper and I need to Lose
        return 1 #Paper covers rock
    elif a == 2 and desiredOutcome == 3:  #Paper and I need to Win
        return 3 #Scissors cut paper
    elif a == 3 and desiredOutcome == 1:  #Scissors and I need to lose
        return 2 #Scissors cut paper
    elif a == 3 and desiredOutcome == 3:  #Scissors and I need to win
        return 1 #Rock beats scissors
    elif desiredOutcome == 2:
        return a
    else:
        print("Something weird happened")
...
for hand in guide_array:
    ...
    desiredOutcome = getValue(hand[1])  # Intended Outcome
    b = rochambeau(a, desiredOutcome)
    processResult(a,b)
